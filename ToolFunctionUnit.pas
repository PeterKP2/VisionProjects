...
uses
  LCLIntf, LCLType, LMessages, SysUtils, Variants, Classes, CameraParamsUnit;
...
begin
  ...
  FillChar(nIntNode, SizeOf(MVCC_INTVALUE), 0);
...
begin
  ...
  pAnsiKey := PAnsiChar(AnsiString(strKey));
  FillChar(enEnumNode, SizeOf(MVCC_ENUMVALUE), 0);
...
begin
  ...
  pAnsiKey := PAnsiChar(AnsiString(strKey));
  FillChar(fFloatNode, SizeOf(MVCC_FLOATVALUE), 0);
...
begin
  ...
  pAnsiKey := PAnsiChar(AnsiString(strKey));
  FillChar(strNode, SizeOf(MVCC_STRINGVALUE), 0);
